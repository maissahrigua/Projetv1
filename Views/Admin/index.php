...
if (isset($_POST["delete"])) {
  ...
  if(isset($_POST["modif"])){
      $data = array(
          ...
          "image" => $this->getAllProductsWithImages($oldImage),
          "categoryid" => $_POST["product_categoryid"],
      );
      ...
      <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
        <div class="app-brand demo">
          <a href="index.html" class="app-brand-link">
            ...
            <span class="app-brand-text demo menu-text fw-bolder ms-2"> Magic Hands </span>
          </a>
          ...
          <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
            ...
            <div class="navbar-nav align-items-center">
              <div class="nav-item d-flex align-items-center">
                ...
                <input type="text" class="form-control border-0 shadow-none" placeholder="Search..." aria-label="Search..."  href="searchproduct.php" />
              </div>
            </div>
            <!-- /Search -->
                        ...
                        <tr>
                          ...
                          <td>
                            <form action="index.php" method="POST">
                              ...
                              <button onClick= name="modif" class="btn btn-outline-warning">
